...
const UserForm102 = () => {
  ...
  useEffect(() => {
    if (id) {
      axios
        .get(`${process.env.REACT_APP_BASE_URL}/usersnbee102/${id}`)
        .then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    if (id) {
      axios
        .put(`${process.env.REACT_APP_BASE_URL}/usersnbee102/${id}`, formData)
        .then((response) => {
